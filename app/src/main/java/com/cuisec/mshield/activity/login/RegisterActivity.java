...
public class RegisterActivity extends LoginBaseActivity {
    ...
    @OnClick({R.id.register_code_btn, R.id.register_eye_iv, R.id.register_server_btn, R.id.register_register_btn})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.register_code_btn: {
                String accountStr = mPhoneEt.getText().toString();
                if (accountStr.length() == 0) {
                    T.showShort(RegisterActivity.this, getString(R.string.mobile_tip));
                    return;
                }

                if (!ValidateUtil.validateMobile(accountStr)) {
                    T.showShort(RegisterActivity.this, getString(R.string.mobile_error));
                    return;
                }
    ...
    private void getMsgCode() {
        ...
        try {
            ...
            OkHttpUtils
                    ...
                    .addParams("smsType", Constants.SMS_SEND_REGISTER)
                    .build()
    ...
    private void userRegister() {
        if (mLoadDlg == null) {
            mLoadDlg = new LoadDialog(RegisterActivity.this, R.style.CustomDialog);
            mLoadDlg.show();
        }
        try {
            ...
            OkHttpUtils
                    .post()
                    .url(SPManager.getServerUrl() + Config.user_register)
                    ...
                    .execute(new StringCallback() {
                        ...
                        public void onError(Call call, Exception e, int id) {
                            ...
                            T.showShort(RegisterActivity.this, getString(R.string.app_network_error));
                        }
                        ...
                        public void onResponse(String response, int id) {
                            ...
                            try {
                                ...
                                if (bean.getRet() == 0) {
                                    ...
                                    T.showShort(RegisterActivity.this, getString(R.string.register_success));
                                } else {
                                    T.showShort(RegisterActivity.this, bean.getMsg());
                                }
                            } catch (Exception e) {
                                T.showShort(RegisterActivity.this, e.getLocalizedMessage());
                            }
                        }
                    });
