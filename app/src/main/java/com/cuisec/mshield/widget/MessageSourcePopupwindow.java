...
public class MessageSourcePopupwindow extends PopupWindow {
    private View view;
    ...
    private class MyHandler extends Handler {
        private WeakReference<MessageSourcePopupwindow> mAddressPopupWindowWeakReference;

        public MyHandler(MessageSourcePopupwindow popupWindow) {
            mAddressPopupWindowWeakReference = new WeakReference<MessageSourcePopupwindow>(popupWindow);
        }
    ...
    public MessageSourcePopupwindow(Context context) {
