package com.cuisec.mshield.widget.signature.views;
...
import com.cuisec.mshield.widget.signature.utils.Bezier;
import com.cuisec.mshield.widget.signature.utils.ControlTimedPoints;
import com.cuisec.mshield.widget.signature.utils.SvgBuilder;
import com.cuisec.mshield.R;
import com.cuisec.mshield.widget.signature.utils.TimedPoint;
...
public class SignaturePad extends View {
    ...
    private Boolean isSignaturing = false;
    ...
    public void setSignatureBitmap(Bitmap signature, int width, int height) {
        ...
        ensureSignatureBitmap(width, height);
        ...
        //不放大居中显示
        //tempDst.set(width /2 - dWidth / 2, height / 2 - dHeight / 2, width / 2 + dWidth / 2, height / 2 + dHeight / 2);
        //放大到高为4/5的width，高宽比不变，居中
        tempDst.set(width / 2 - height * 2 / 5 * dWidth / dHeight, height / 10, width / 2 + height * 2 / 5 * dWidth / dHeight, height * 9 / 10);

        Matrix drawMatrix = new Matrix();
        drawMatrix.setRectToRect(tempSrc, tempDst, Matrix.ScaleToFit.CENTER);
//        drawMatrix.setRectToRect(tempSrc, tempDst, Matrix.ScaleToFit.FILL);
    ...
    private void ensureSignatureBitmap(int width, int height) {
